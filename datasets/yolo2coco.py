...
parser.add_argument('--image_path', default=r'C:\software\mydemo\DEIM\datasets\Maize\train\images', type=str,
                    help="path of images")
parser.add_argument('--label_path', default=r'C:\software\mydemo\DEIM\datasets\Maize\train\labels', type=str,
                    help="path of labels .txt")
parser.add_argument('--save_path', default=r'C:\software\mydemo\DEIM\datasets\Maize\COCO/train.json', type=str,
