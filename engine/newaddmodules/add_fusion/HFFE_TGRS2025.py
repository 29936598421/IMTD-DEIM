...
class HFFE(nn.Module):
    def __init__(self, feature_low_channel,kernel_size=3):
        super(HFFE, self).__init__()
        feature_high_channel = feature_low_channel
        out_channel = feature_low_channel
...
if __name__ == '__main__':
    ...
    # 创建 HFFE 模块
    model = HFFE(feature_low_channel=32, feature_high_channel=64)
    # 将输入图像传入 HFFE 模块进行处理
