...
class LSB_down(nn.Module):
    def __init__(self, inplanes,  outplanes, down_or_up='down', groups=4):
        super(LSB_down, self).__init__()
...
if __name__ == '__main__':
    ...
    # 创建 LSB 模块
    LSB_down = LSB_down(inplanes=32,outplanes=32,down_or_up='up')
